...
var q, jsonFeedUrl = "http://cumacerita.github.io/feed.json",
...
function processData() {
    ...
    return function(data) {
        ...
        $.each(data, function(index, item) {
            // check if search term is in category, content, or title
            if (item.search_omit != "true" && (item.category.toLowerCase().indexOf(q.toLowerCase()) > -1 || item.content.toLowerCase().indexOf(q.toLowerCase()) > -1 || item.title.toLowerCase().indexOf(q.toLowerCase()) > -1)) {
